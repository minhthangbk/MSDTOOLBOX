...
if nargin == 5 | nargin == 6 & plot_freq_response == 1
    ...
    elseif length(q) == 6
        legend('Ideal', ['Quantized ' num2str(q(1)) '-bit'], ['Quantized ' num2str(q(2)) '-bit'],  ['Quantized ' num2str(q(3)) '-bit'], ...
            ['Quantized ' num2str(q(4)) '-bit'], ['Quantized ' num2str(q(5)) '-bit'], ['Quantized ' num2str(q(6)) '-bit']);
    elseif length(q) == 7
        legend('Ideal', ['Quantized ' num2str(q(1)) '-bit'], ['Quantized ' num2str(q(2)) '-bit'],  ['Quantized ' num2str(q(3)) '-bit'], ...
            ['Quantized ' num2str(q(4)) '-bit'], ['Quantized ' num2str(q(5)) '-bit'], ['Quantized ' num2str(q(6)) '-bit'], ['Quantized ' num2str(q(7)) '-bit']);
    end
end
